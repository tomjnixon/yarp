...
def _function_call_on_argument_value_change(
    call_immediately, callback, *value_args, **value_kwargs
):
    """
...
def fn(f):
    ...
    def instance_maker(*args, **kwargs):
        ...
        _function_call_on_argument_value_change(True, callback, *args, **kwargs)
        return output_value
...
def instantaneous_fn(f):
    ...
    def instance_maker(*args, **kwargs):
        ...
        _function_call_on_argument_value_change(False, callback, *args, **kwargs)
        return output_value
